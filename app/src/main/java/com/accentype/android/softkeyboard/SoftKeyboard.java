...
import static com.accentype.android.softkeyboard.Themes.MY_PREFS_NAME;
...
int id=0;
    ...
    public View onCreateInputView()
    {
        ...
        {
            schema = color;
            mInputView = (LatinKeyboardView) getLayoutInflater().inflate(R.layout.indigo, null);
            mInputView.setOnKeyboardActionListener(this);
            setLatinKeyboard(mQwertyKeyboard);
            return mInputView;
        }
        else if(color==3)
        {
            //violet
            schema = color;
            mInputView = (LatinKeyboardView) getLayoutInflater().inflate(R.layout.violet, null);
            mInputView.setOnKeyboardActionListener(this);
            setLatinKeyboard(mQwertyKeyboard);
            return mInputView;
        }
        else if(color==4)
        {
            //green
            schema = color;
            mInputView = (LatinKeyboardView) getLayoutInflater().inflate(R.layout.input2, null);
            mInputView.setOnKeyboardActionListener(this);
            setLatinKeyboard(mQwertyKeyboard);
            return mInputView;
        }
...
//            return mInputView;
//        }
        return mInputView=(LatinKeyboardView) getLayoutInflater().inflate(R.layout.input1, null);
    }
